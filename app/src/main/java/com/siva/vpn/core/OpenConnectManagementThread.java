...
import com.siva.vpn.handlers.AuthFormHandler;
...
public class OpenConnectManagementThread implements Runnable, OpenVPNManagement {
    ...
    private boolean isCertAccepted(String hash) {
        return mAcceptedCerts.containsKey(hash) ||
...
//			}
	...
	private void errorAlert() {
		errorAlert(mContext.getString(R.string.error_cant_connect, SharedPreferencesManager.getString("Selected_server" ,"Connected")));
	}
